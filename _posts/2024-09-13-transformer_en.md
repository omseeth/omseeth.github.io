...
{% include figure.liquid loading="eager" path="assets/img/positional_encoding_en.png" class="img-fluid mx-auto d-block" width="90%" %}**Fig. 6:** Exemplary sequence, whose tokens are mapped to positional encodings with $$d=4$$
