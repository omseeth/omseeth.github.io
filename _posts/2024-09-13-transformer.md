...
{% include figure.liquid loading="eager" path="assets/img/transformer_decoder_ger.png" class="img-fluid mx-auto d-block" width="70%" %}**Fig. 10:** Dekodierer eines Transformer-Modells
