...
{% include figure.liquid loading="eager" path="assets/img/recurrent_net.png" class="img-fluid mx-auto d-block" width="40%" %}**Fig 1:** Status eines neuronalen Netzes ohne (*feedforward*) und mit Feed-back (rekurrent) sowie jeweils einer Eingabeschicht $$x$$, einer verborgenen Schicht $$h1$$ und einer Ausgabe $$a$$
